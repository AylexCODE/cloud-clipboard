...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **GET** | `/list` | `namespace, sort` | `None` | `None` | Returns an array of available clipboards with metadata e.g. `[{ "name": string, "size": number, "fileCount": number, "updatedAt": string }]` |
